    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participants', models.ManyToManyField(db_table='participants', limit_choices_to={'is_active', True}, related_name='participants', to='profiles.Profile', verbose_name='파티 참가자')),
                ('party_owner', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='owner', to='profiles.Profile', verbose_name='파티 주최자')),
            ],
            options={
                'verbose_name': '파티',
